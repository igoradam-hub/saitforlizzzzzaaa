...
const defaultContent = {
    ...
    jury: {
        ...
        members: [
            { name: "Анна Жолобова", position: "Управляющий партнер московского офиса Коллегии адвокатов «Регионсервис», член Комитета по административным процедурам Ассоциации «Национальное объединение строителей» (НОСТРОЙ), LL.M.", photo: "images/photos/zholobova.png" },
            { name: "Екатерина Гемпик", position: "Руководитель Управления нормативно-правового обеспечения градостроительной деятельности ГК «Страна Девелопмент», член Комитета по административным процедурам в строительстве НОСТРОЙ", photo: "images/photos/gempik.jpg" },
            { name: "Максим Галь", position: "Заместитель директора департамента комплексного развития территорий Минстроя России", photo: "images/photos/gal.jpg" },
            { name: "Павел Мельников", position: "Директор по развитию московского подразделения ПАО «Группа ЛСР», одного из крупнейших застройщиков Российской Федерации", photo: "images/photos/melnikov.jpeg" },
            { name: "Алексей Башарин", position: "Эксперт по градостроительным и земельным вопросам. Приглашенный лектор по градостроительному и земельному праву СПбГУ, НИУ ВШЭ, Юридического института М-Логос, Legal Academy", photo: "images/photos/basharin.png" },
            { name: "Ольга Фаизова", position: "Руководитель правового сопровождения инвестиционной деятельности ООО «Брусника»", photo: "images/photos/faizova.jpg" },
            { name: "Максим Малютин", position: "Член жюри", photo: "images/photos/malyutin.jpg" },
            { name: "Алексей Бутовецкий", position: "Статс-секретарь — заместитель руководителя Росреестра", photo: "" }
        ],
        scientificAdvisors: [
            { name: "Леонид Бандорин", position: "Доцент кафедры экологического и земельного права Юридического факультета Московского государственного университета имени М.В. Ломоносова, кандидат юридических наук", photo: "images/photos/bandorin.png" },
            { name: "Надежда Заславская", position: "Профессор кафедры экологического и земельного права Юридического факультета Московского государственного университета имени М.В. Ломоносова, доктор юридических наук", photo: "" },
            { name: "Андрей Переладов", position: "Сопредседатель КА «Регионсервис», управляющий партнер офиса в г. Кемерово, руководитель практики «Экология и природопользование». Глава государственной экзаменационной комиссии Юридического института Кемеровского государственного университета", photo: "images/photos/pereladov.png" }
        ]
    },
    organizers: {
        label: "Команда",
    ...
    partners: {
        ...
        support: {
            title: "При поддержке",
            items: [
                { name: "Правительство Российской Федерации", logo: "images/partners/pravitelstvo.webp" },
        ...
        partners: {
            ...
            items: [
                ...
                { name: "Брусника", logo: "images/partners/брусника.png" },
                { name: "Страна Девелопмент", logo: "images/partners/страна девелопмент.png" }
            ]
        },
        infoPartnerMain: {
...
function getContent() {
    try {
        ...
        // Always use default partners and jury (bundled with code)
        result.partners = defaultContent.partners;
        result.jury = defaultContent.jury;
        return result;
    } catch {
